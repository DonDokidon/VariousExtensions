...
public abstract class ParallaxBackgroundNestedScrollView extends NestedScrollView {
    ...
    public ParallaxBackgroundNestedScrollView(Context context) {
        super(context);
        init(context);
    }

    public ParallaxBackgroundNestedScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ParallaxBackgroundNestedScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
